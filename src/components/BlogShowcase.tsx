      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {language === 'zh-CN' ? '最新技术博客' : 
             language === 'zh-HK' ? '最新技術博客' : 'Latest Tech Blog'}
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            {language === 'zh-CN' ? '探索最新的技术趋势、开发技巧和最佳实践' : 
             language === 'zh-HK' ? '探索最新嘅技術趨勢、開發技巧同最佳實踐' : 
             'Explore the latest technology trends, development tips and best practices'}
          </p>
        </div>
