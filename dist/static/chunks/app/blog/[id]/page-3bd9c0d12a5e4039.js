(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7567],{1677:(e,t,a)=>{Promise.resolve().then(a.bind(a,3280))},3280:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>h});var s=a(5155),n=a(2115),r=a(1693),o=a(9233),i=a(8500),l=a.n(i),c=a(8426),d=a(2957);let m=[{id:1,title:{"zh-CN":"ChatGPT Atlas浏览器官网下载 - OpenAI推出的AI智能浏览器","zh-HK":"ChatGPT Atlas瀏覽器官網下載 - OpenAI推出嘅AI智能瀏覽器",en:"ChatGPT Atlas Browser Official Download - AI Smart Browser by OpenAI"},excerpt:{"zh-CN":"OpenAI推出的革命性AI浏览器，集成ChatGPT智能助手，支持侧边栏聊天、智能记忆、自动化操作等创新功能。","zh-HK":"OpenAI推出嘅革命性AI瀏覽器，集成ChatGPT智能助手，支持側邊欄聊天、智能記憶、自動化操作等創新功能。",en:"Revolutionary AI browser by OpenAI, integrating ChatGPT smart assistant, supporting sidebar chat, intelligent memory, automation and other innovative features."},content:{"zh-CN":`# ChatGPT Atlas浏览器简介
...
*本文由星点工具箱团队原创，转载请注明出处*`,"zh-HK":`# ChatGPT Atlas瀏覽器簡介
...
*本文由星點工具箱團隊原創，轉載請註明出處*`,en:`# ChatGPT Atlas Browser Introduction
...
*This article is originally created by StarDot Tools Team, please indicate the source when reprinting*`},category:{"zh-CN":"AI工具","zh-HK":"AI工具",en:"AI Tools"},date:"2025-10-23",readTime:{"zh-CN":"5分钟阅读","zh-HK":"5分鐘閱讀",en:"5 min read"},featured:!0,tags:["ChatGPT浏览器","AI浏览器","OpenAI","Atlas浏览器","智能浏览器","AI助手"]},{id:2,title:{"zh-CN":"Perplexity Comet浏览器官网下载 - AI驱动的智能浏览器","zh-HK":"Perplexity Comet瀏覽器官網下載 - AI驅動嘅智能瀏覽器",en:"Perplexity Comet Browser Official Download - AI-Powered Smart Browser"},excerpt:{"zh-CN":"Comet是由Perplexity推出的AI智能浏览器，集成强大的AI助手功能，支持智能搜索、内容理解、标签管理等创新功能。","zh-HK":"Comet係由Perplexity推出嘅AI智能瀏覽器，集成強大嘅AI助手功能，支持智能搜索、內容理解、標籤管理等創新功能。",en:"Comet is an AI smart browser launched by Perplexity, integrating powerful AI assistant features, supporting intelligent search, content understanding, tag management and other innovative functions."},content:{"zh-CN":`
      ...
      `},category:{"zh-CN":"AI工具","zh-HK":"AI工具",en:"AI Tools"},date:"2025-10-23",readTime:{"zh-CN":"4分钟阅读","zh-HK":"4分鐘閱讀",en:"4 min read"},featured:!0,tags:["AI浏览器","Perplexity","Comet","智能浏览器","AI助手","Comet浏览器下载"]}];function h({params:e}){let{language:t}=(0,r.o)(),a=o.P9[t],[i,h]=n.useState(null),[p,u]=n.useState(null);return(n.useEffect(()=>{(async()=>{let t=parseInt((await e).id);u(t),h(m.find(e=>e.id===t))})()},[e]),i)?((e=>{let t,a=/^(#{1,6})\s+(.+)$/gm,s=[];for(;null!==(t=a.exec(e));){let e=t[1].length,a=t[2].trim(),n=a.toLowerCase().replace(/[^\w\u4e00-\u9fa5]+/g,"-");s.push({level:e,text:a,id:n})}})(i.content[t]),m.filter(e=>e.id!==i.id&&e.category[t]===i.category[t]).slice(0,3),(0,s.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-gray-50 to-gray-100",children:[(0,s.jsx)("div",{className:"bg-white border-b border-gray-200",children:(0,s.jsxs)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:[(0,s.jsxs)("nav",{className:"flex items-center space-x-2 text-sm text-gray-500 mb-6",children:[(0,s.jsx)(l(),{href:"/",className:"hover:text-blue-600 transition-colors",children:"首页"}),(0,s.jsx)("span",{children:"›"}),(0,s.jsx)(l(),{href:"/blog",className:"hover:text-blue-600 transition-colors",children:a.blog.title}),(0,s.jsx)("span",{children:"›"}),(0,s.jsx)("span",{className:"text-gray-900",children:i.title[t]})]}),(0,s.jsxs)("div",{className:"text-center",children:[(0,s.jsx)("span",{className:"inline-block px-3 py-1 bg-blue-100 text-blue-800 text-sm font-medium rounded-full mb-4",children:i.category[t]}),(0,s.jsx)("h1",{className:"text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight",children:i.title[t]}),(0,s.jsxs)("div",{className:"flex justify-center items-center space-x-6 text-sm text-gray-500",children:[(0,s.jsxs)("span",{className:"flex items-center",children:[(0,s.jsx)("svg",{className:"w-4 h-4 mr-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,s.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"})}),i.date]}),(0,s.jsxs)("span",{className:"flex items-center",children:[(0,s.jsx)("svg",{className:"w-4 h-4 mr-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,s.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),i.readTime[t]]})]})]})]})}),(0,s.jsxs)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,s.jsx)("div",{className:"bg-white rounded-xl shadow-sm border border-gray-100 p-8 md:p-12",children:(0,s.jsx)("article",{className:"prose prose-lg max-w-none",children:(0,s.jsx)(c.oz,{remarkPlugins:[d.A],components:{h1:({node:e,...t})=>(0,s.jsx)("h1",{id:t.children?.toString().toLowerCase().replace(/[^\w\u4e00-\u9fa5]+/g,"-"),className:"text-3xl font-bold text-gray-900 mt-12 mb-6 pb-2 border-b border-gray-200",...t}),h2:({node:e,...t})=>(0,s.jsx)("h2",{id:t.children?.toString().toLowerCase().replace(/[^\w\u4e00-\u9fa5]+/g,"-"),className:"text-2xl font-semibold text-gray-800 mt-10 mb-4",...t}),h3:({node:e,...t})=>(0,s.jsx)("h3",{id:t.children?.toString().toLowerCase().replace(/[^\w\u4e00-\u9fa5]+/g,"-"),className:"text-xl font-semibold text-gray-800 mt-8 mb-3",...t}),h4:({node:e,...t})=>(0,s.jsx)("h4",{id:t.children?.toString().toLowerCase().replace(/[^\w\u4e00-\u9fa5]+/g,"-"),className:"text-lg font-medium text-gray-800 mt-6 mb-2",...t}),h5:({node:e,...t})=>(0,s.jsx)("h5",{id:t.children?.toString().toLowerCase().replace(/[^\w\u4e00-\u9fa5]+/g,"-"),className:"text-base font-medium text-gray-800 mt-4 mb-2",...t}),h6:({node:e,...t})=>(0,s.jsx)("h6",{id:t.children?.toString().toLowerCase().replace(/[^\w\u4e00-\u9fa5]+/g,"-"),className:"text-sm font-medium text-gray-800 mt-3 mb-1",...t}),p:({node:e,...t})=>(0,s.jsx)("p",{className:"text-gray-700 leading-relaxed mb-6",...t}),ul:({node:e,...t})=>(0,s.jsx)("ul",{className:"list-disc list-inside text-gray-700 mb-6 space-y-2",...t}),ol:({node:e,...t})=>(0,s.jsx)("ol",{className:"list-decimal list-inside text-gray-700 mb-6 space-y-2",...t}),li:({node:e,...t})=>(0,s.jsx)("li",{className:"pl-2",...t}),strong:({node:e,...t})=>(0,s.jsx)("strong",{className:"font-semibold text-gray-900",...t}),em:({node:e,...t})=>(0,s.jsx)("em",{className:"italic text-gray-800",...t}),a:({node:e,...t})=>(0,s.jsx)("a",{className:"text-blue-600 hover:text-blue-800 underline transition-colors",...t}),blockquote:({node:e,...t})=>(0,s.jsx)("blockquote",{className:"border-l-4 border-blue-500 pl-4 italic text-gray-600 my-6",...t}),code:({node:e,...t})=>{let{className:a,children:n,...r}=t;return a?.includes("inline")?(0,s.jsx)("code",{className:"bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono",...r,children:n}):(0,s.jsx)("code",{className:"block bg-gray-100 text-gray-800 p-4 rounded-lg text-sm font-mono my-4 overflow-x-auto",...r,children:n})},table:({node:e,...t})=>(0,s.jsx)("div",{className:"overflow-x-auto my-6",children:(0,s.jsx)("table",{className:"min-w-full border-collapse border border-gray-300",...t})}),th:({node:e,...t})=>(0,s.jsx)("th",{className:"border border-gray-300 px-4 py-2 bg-gray-100 font-semibold text-gray-900",...t}),td:({node:e,...t})=>(0,s.jsx)("td",{className:"border border-gray-300 px-4 py-2 text-gray-700",...t})},children:i.content[t]})})}),(0,s.jsxs)("div",{className:"mt-12 text-center",children:[(0,s.jsxs)(l(),{href:"/blog",className:"inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-md hover:shadow-lg",children:[(0,s.jsx)("svg",{className:"w-5 h-5 mr-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,s.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),"返回博客列表"]}),(0,s.jsx)("div",{className:"mt-6 text-sm text-gray-500",children:(0,s.jsx)("span",{children:"\xa9 2024 星点工具箱 • 专注于优质工具和教程"})})]})]})]})):(0,s.jsx)("div",{className:"min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center",children:(0,s.jsxs)("div",{className:"text-center",children:[(0,s.jsx)("div",{className:"w-24 h-24 mx-auto mb-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center",children:(0,s.jsx)("svg",{className:"w-12 h-12 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,s.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 2a10 10 0 00-3.41 19.4c.5.09.68-.22.68-.48v-1.7c-2.78.6-3.37-1.34-3.37-1.34-.45-1.15-1.11-1.46-1.11-1.46-.9-.62.07-.61.07-.61 1 .07 1.53 1.03 1.53 1.03.89 1.52 2.34 1.08 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.27.1-2.65 0 0 .84-.27 2.75 1.02A9.58 9.58 0 0112 6.84c.85.004 1.7.115 2.5.34 1.91-1.29 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85v2.74c0 .27.18.58.69.48A10 10 0 0012 2z"})})}),(0,s.jsx)("h1",{className:"text-3xl md:text-4xl font-bold text-gray-900 mb-4",children:"加载中..."}),(0,s.jsx)("p",{className:"text-gray-600 mb-8 max-w-md mx-auto",children:"正在加载博客文章内容，请稍候。"})]})})}}},e=>{e.O(0,[8500,2454,1693,8441,3794,7358],()=>e(e.s=1677)),_N_E=e.O()}]);